...
class NetworkInstrumentedTest {
    ...
    fun testRequestingServerInfo() {
        ...
        mockServer.url("https://api.eosnewyork.io/v1/chain/get_info")
    ...
    fun testRequestBlockData() {
        ...
        mockServer.url("https://api.eosnewyork.io/v1/chain/get_block")
        val block = Utils.requestBlock(okHttpClient, "01d9a8396abc62f28a9a8ecae190c0353ad3e27bb10be76bd3ab302e5a76f82c")
